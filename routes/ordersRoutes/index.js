...
import { validateInsertOrderSchema, checksCakeAndClientExistence, validateDataType, checkOrderIdExistence, validateClientId, validateOrderId, checkOrderIdDeliveryStatus } from "../../middlewares/ordersMiddlewares.js";
...
ordersRouter.patch("/order/:id", validateOrderId, checkOrderIdExistence, checkOrderIdDeliveryStatus, ordersController.changeDeliveryStatus);
